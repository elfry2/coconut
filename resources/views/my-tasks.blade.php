            ...
            <div class="modal fade" id="task{{ $task->id }}DeletionModal" aria-labelledby="task{{ $task->id }}DeletionModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>This action cannot be undone. @if (!$task->is_completed) If you want to mark the task as completed, click on <b><i class="bi bi-check-square me-1"></i>Mark completed</b> instead. @else If you want to abort the completion status, click on <b><i class="bi bi-square me-1"></i>Mark incomplete</b> instead.@endif</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn" data-bs-dismiss="modal">Close</button>
